...
import static com.booknest.utils.MasterData.getUserDTO;
...
public class UserControllerTest {
	...
	public void testGetUserProfile() throws Exception {
		...
		when(userService.getUserProfile(userId)).thenReturn(userDTO);
	...
	public void testUpdateUserProfile() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/api/users/profile/" + userId)
				.content(MasterData.asJsonString(userDTO)).contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON);
